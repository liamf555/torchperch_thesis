...
def u_transfer_function(airspeed):
...
def v_transfer_function(airspeed):
    #turbulence level defines value of wind speed in knots at 20 feet
    # turbulence_level = 15 * 0.514444 # convert speed from knots to meters per second
    turbulence_level = 15 
    length_v = 200
...
def w_transfer_function(airspeed):
    #turbulence level defines value of wind speed in knots at 20 feet
    # turbulence_level = 15 * 0.514444 # convert speed from knots to meters per second
    turbulence_level = 15 
    length_w = 50
...
def dryden_wind_velocities(airspeed):
    ...
    tf_u = u_transfer_function(airspeed)
    tf_v = v_transfer_function(airspeed)
    tf_w = w_transfer_function(airspeed)
