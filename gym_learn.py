...
from stable_baselines3.common.vec_env import VecNormalize, DummyVecEnv, VecFrameStack, VecExtractDictObs
...
env = make_vec_env(lambda: gym.make(params.get(
    "env"), parameters=params), n_envs=8, seed=0)
...
final_rewards = evaluate_policy(
    final_model, eval_env, n_eval_episodes=500, return_episode_rewards=False, render=False)
best_model_rewards = evaluate_policy(
    best_model, eval_env, n_eval_episodes=500, return_episode_rewards=False, render=False)
